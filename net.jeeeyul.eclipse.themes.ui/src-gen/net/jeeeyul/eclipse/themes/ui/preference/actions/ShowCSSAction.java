...
public class ShowCSSAction extends AbstractPreferenceAction {
  public ShowCSSAction(final JTPreferencePage page) {
    super(page);
    this.setText("Show CSS");
  ...
  public void run() {
    ...
    CustomThemeGenerator generator = new CustomThemeGenerator(tempStore);
    final String css = generator.generate();
