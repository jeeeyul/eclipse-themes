...
class KTabSettings {
	...
	@Property Color borderColor = COLOR_GRAY
	@Property Color innerBorderColor = COLOR_GRAY
	@Property int shadowRadius = 0
	
	@Property Color closeButtonColor = COLOR_GRAY
	@Property Color hotCloseButtonColor = COLOR_DARK_RED
