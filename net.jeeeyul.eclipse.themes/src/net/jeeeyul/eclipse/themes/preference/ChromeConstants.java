...
public interface ChromeConstants {
	...
	public static final String CHROME_LOCK_END_HUE = "chrome-lock-end-hue";
	public static final String CHROME_AUTO_END_COLOR = "chrome-auto-end-color";
	
	public static final String CHROME_LOCK_OUTLINE_HUE = "chrome-lock-outline-hue";
	public static final String CHROME_AUTO_OUTLINE_COLOR = "chrome-auto-outline-color";
